...
char lcd_str_h[16];
char lcd_str_l[16];
extern uint8_t twi_addr = 0b01001000;
extern uint8_t twi_data[1] = {0};
extern uint8_t byte_cnt = 0;
...
{     
  ...
  // ...
  twi_start_wr(twi_addr, twi_data, byte_cnt);
